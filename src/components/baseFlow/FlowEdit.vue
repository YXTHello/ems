...
<template>
	<div>
		...
		<el-row style='margin-bottom: 20px;'>
			...
			<el-col :span="12">
				<el-select v-model='dljid' style='width:45%' placeholder="请选择">
		...
		<el-row style='margin-bottom: 20px;'>
			<el-col :span="12">
				<el-select v-model='zcjid' style='width:45%' placeholder="请选择">
					<el-option v-for='obj in zcjArr' :key="obj.devid" :label='obj.devname' :value='obj.devid'></el-option>
				</el-select>
			</el-col>
			<el-col :span="12">
				<el-select v-model='pdjid' style='width:45%' placeholder="请选择">
